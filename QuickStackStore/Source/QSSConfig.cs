...
namespace QuickStackStore
{
    ...
    internal class QSSConfig
    {
        ...
        internal static void LoadConfig(QuickStackStorePlugin plugin)
        {
            ...
            GeneralConfig.OverrideButtonDisplay.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin, true);
            ...
            DisplayQuickStackButtons.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin);
            ...
            DisplayStoreAllButton.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin);
            ...
            DisplaySortButtons.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin);
            ...
            DisplaySortCriteriaInLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin);
            ...
            DisplayTrashCanUI.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonRelevantSettingChanged(plugin, true);
            ...
            TrashLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            QuickStackLabel = Config.Bind(sectionName, nameof(QuickStackLabel), string.Empty, string.Empty);
            QuickStackLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            StoreAllLabel = Config.Bind(sectionName, nameof(StoreAllLabel), string.Empty, string.Empty);
            StoreAllLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            TakeAllLabel = Config.Bind(sectionName, nameof(TakeAllLabel), string.Empty, string.Empty);
            TakeAllLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            RestockLabel = Config.Bind(sectionName, nameof(RestockLabel), string.Empty, string.Empty);
            RestockLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortLabel = Config.Bind(sectionName, nameof(SortLabel), string.Empty, string.Empty);
            SortLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            QuickStackLabelCharacter = Config.Bind(sectionName, nameof(QuickStackLabelCharacter), string.Empty, string.Empty);
            QuickStackLabelCharacter.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortLabelCharacter = Config.Bind(sectionName, nameof(SortLabelCharacter), string.Empty, string.Empty);
            SortLabelCharacter.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            RestockLabelCharacter = Config.Bind(sectionName, nameof(RestockLabelCharacter), string.Empty, string.Empty);
            RestockLabelCharacter.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortByInternalNameLabel = Config.Bind(sectionName, nameof(SortByInternalNameLabel), string.Empty, string.Empty);
            SortByInternalNameLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortByTranslatedNameLabel = Config.Bind(sectionName, nameof(SortByTranslatedNameLabel), string.Empty, string.Empty);
            SortByTranslatedNameLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortByValueLabel = Config.Bind(sectionName, nameof(SortByValueLabel), string.Empty, string.Empty);
            SortByValueLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortByWeightLabel = Config.Bind(sectionName, nameof(SortByWeightLabel), string.Empty, string.Empty);
            SortByWeightLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();

            SortByTypeLabel = Config.Bind(sectionName, nameof(SortByTypeLabel), string.Empty, string.Empty);
            SortByTypeLabel.SettingChanged += (a, b) => ButtonRenderer.instance.OnButtonTextTranslationSettingChanged();
